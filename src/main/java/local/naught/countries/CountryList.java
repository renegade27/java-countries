...
public class CountryList
{
    ...
    public ArrayList<String> getNames() {
        ...
        for(Country c : countryList) {
            tempCountryList.add(c.getName());
        }

        System.out.println(tempCountryList);
...
//    }
    ...
    public ArrayList<Country> findCountriesByLetter(CheckCountry tester)
    {
    ...
    public ArrayList<Country> findCountriesByLength(CheckCountry tester)
    {
        ArrayList<Country> tempCountryList = new ArrayList<>();
    ...
    public ArrayList<Country> findCountriesBySize(CheckCountry tester)
    {
        ArrayList<Country> tempCountryList = new ArrayList<>();
